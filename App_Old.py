...
class App(ctk.CTk):
    ...
    def PlotData(self):
        ...
        gs = gridspec.GridSpec(2, 2, height_ratios=[1, 0.5])  # 2 linhas e 2 colunas, com ajuste de proporções
        ...
        # Gera o gráfico da intensidade integrada
    ...
    def CalculateIntegral(self):
        ...
        self.ax_integrated.scatter(vertical_axis, integrals)
        self.ax_integrated.plot(vertical_axis, integrals, linestyle='dashed')
                
        self.ax_integrated.set_xlabel("Custom variable (arb. u.)")
        self.ax_integrated.set_ylabel("Integrated intensity (arb. u.)")
